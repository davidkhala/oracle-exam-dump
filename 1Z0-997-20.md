...
1. Which three scenarios are suitable for the Oracle Infrastructure (OCI) Autonomous Transaction Processing Shared (ATP-S) deployment? 
    ...
    - [x] A small startup is deploying a new application for eCommerce and it requires database to store customers' transactions without knowing of what the load will look like since it is a new application. 
